...
import {
  STATS, EQUIPMENT_SLOTS, WEAPON_TYPES, SKILL_CATEGORIES,
...
export const DEFAULT_WEAPONS = Object.freeze([
  {
    ...
    weaponType: WEAPON_TYPES.ONE_HANDED.key,
    rarity: ITEM_RARITY.COMMON.key,
    levelReq: 1,
    stats: {
      ATK: 8,
      ATK_SPEED: 5,
    },
    proficiencyBonus: { category: SKILL_CATEGORIES.MUGONG.key, amount: 1 },
  },
  {
    id: 'wpn_crescent_blade',
    name: 'Crescent Moon Blade',
    nameKo: '언월도',
    description: '반달 모양의 날이 달린 장병기. 강력하지만 느리다.',
    type: ITEM_TYPES.WEAPON.key,
    slot: EQUIPMENT_SLOTS.WEAPON.key,
    weaponType: WEAPON_TYPES.TWO_HANDED.key,
    rarity: ITEM_RARITY.UNCOMMON.key,
    levelReq: 8,
    stats: {
      ATK: 22,
      STR: 3,
    ...
    proficiencyBonus: { category: SKILL_CATEGORIES.MUGONG.key, amount: 2 },
  },
  {
    id: 'wpn_twin_daggers',
    ...
    type: ITEM_TYPES.WEAPON.key,
    slot: EQUIPMENT_SLOTS.WEAPON.key,
    weaponType: WEAPON_TYPES.DUAL_WIELD.key,
    rarity: ITEM_RARITY.RARE.key,
    levelReq: 15,
    stats: {
      ATK: 16,
      AGI: 7,
    ...
    proficiencyBonus: { category: SKILL_CATEGORIES.MUGONG.key, amount: 3 },
  },
  {
    id: 'wpn_heaven_sword',
    ...
    proficiencyBonus: { category: SKILL_CATEGORIES.MUGONG.key, amount: 5 },
  },
  {
    id: 'wpn_dragon_spear',
    ...
    slot: EQUIPMENT_SLOTS.WEAPON.key,
    weaponType: WEAPON_TYPES.TWO_HANDED.key,
    rarity: ITEM_RARITY.LEGENDARY.key,
    levelReq: 45,
    stats: {
      ATK: 65,
      STR: 15,
    ...
    proficiencyBonus: { category: SKILL_CATEGORIES.MUGONG.key, amount: 8 },
  },
  {
    id: 'wpn_void_fan',
    name: 'Void Silk Fan',
    ...
    proficiencyBonus: { category: SKILL_CATEGORIES.JUSUL.key, amount: 4 },
  },
]);
