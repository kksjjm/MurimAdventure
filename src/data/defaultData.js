...
export const DEFAULT_SKILLS = Object.freeze([
  {
    ...
    skill_template_id: 'skill_basic_attack',
    module_id: 'skill_system',
    name: 'Basic Attack',
    nameKo: '기본공격',
    description: '스페이스바 입력으로 실행되는 기본 공격입니다. 이 스킬의 이펙트 스프라이트가 스프라이트 관리에서 기본공격 이펙트로 사용됩니다.',
    ...
    range: 60,
    effects: [{ type: EFFECT_TYPES.DAMAGE.key, scaling: { ATK: 1.0, STR: 0.2 } }],
    proficiencyGain: 3,
  },
  {
    id: 'skill_slash',
...
export const DEFAULT_NPCS = Object.freeze([
  {
    id: 'npc_elder',
    ...
    dialogues: {
      default: [
        '관리자 데이터로 구성된 월드입니다.',
        '맵, 스폰, 스킬, 스프라이트를 관리자 페이지에서 수정할 수 있습니다.',
      ],
    },
    quests: [],
    shopType: null,
  },
  {
    ...
    dialogues: {
      default: ['장비와 무기 데이터를 확인합니다.'],
      shop: ['관리자 데이터에 등록된 무기 상점입니다.'],
    },
    quests: [],
    shopType: 'weapon',
  },
  {
    ...
    dialogues: {
      default: ['소모품과 재료 데이터를 확인합니다.'],
      shop: ['관리자 데이터에 등록된 잡화 상점입니다.'],
    },
    quests: [],
    shopType: 'general',
  },
  {
    ...
    texture: 'npc_guard',
    dialogues: {
      default: ['몬스터 AI와 전투 테스트 스폰을 관리자 맵 데이터로 확인합니다.'],
    },
    quests: [],
    shopType: null,
  },
  {
    ...
    dialogues: {
      default: ['제작과 재료 시스템은 관리자 데이터로 확장할 수 있습니다.'],
    },
    quests: [],
    shopType: null,
  },
...
export const DEFAULT_SHOPS = Object.freeze({
  weapon: {
    id: 'weapon',
    nameKo: '무기 상점',
    items: [
